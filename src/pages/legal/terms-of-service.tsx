        ...
        <ThemeProvider theme={theme}>
            ...
            <StyledContainer>
                ...
                <p>
                    ...
                    software) no site
                    matching.bet, apenas para visualização transitória pessoal e não comercial. Esta é a
                    concessão de uma
                ...
                <p>
                    ...
                    poderá
                    ser rescindida por matching.bet a qualquer momento. Ao encerrar a visualização desses
                    materiais ou após o término desta licença, você deve apagar todos os materiais baixados em
                    sua posse, seja em formato eletrónico ou impresso.</p>            <h2>3. Isenção de
                responsabilidade</h2>
                <ol>
                    <li>
                        Os materiais no site da matching.bet são fornecidos &amp;apos;como estão&amp;apos;. matching.bet
                        não
                    ...
                    <li>
                        Além disso, o matching.bet não garante ou faz qualquer representação relativa à
                ...
                <h2>4. Limitações</h2>
                <p>
                    Em nenhum caso o matching.bet ou seus fornecedores serão
                    responsáveis ​​por quaisquer danos (incluindo, sem limitação, danos por perda de dados ou
                    lucro
                    ou devido a interrupção dos negócios) decorrentes do uso ou da incapacidade de usar os
                    materiais
                    em matching.bet, mesmo que matching.bet ou um representante autorizado da matching.bet tenha
                ...
                <p>Os materiais exibidos no site da matching.bet
                    podem incluir erros técnicos, tipográficos ou fotográficos. matching.bet não garante que
                    qualquer material em seu site seja preciso, completo ou atual. matching.bet pode fazer
                    alterações nos materiais contidos em seu site a qualquer momento, sem aviso prévio. No
                    entanto,
                    matching.bet não se compromete a atualizar os materiais.</p>
                <h2>6. Links</h2>
                <p>
                    O matching.bet não analisou todos os sites vinculados ao seu site e não é responsável pelo
                    conteúdo de nenhum site vinculado. A inclusão de qualquer link não implica endosso por
                    matching.bet do site. O uso de qualquer site vinculado é por conta e risco do usuário.</p>
                <h3>Modificações</h3>
                <p>
                    O matching.bet pode revisar estes termos de
                    serviço do site a qualquer momento, sem aviso prévio. Ao usar este site, você concorda em
                    ficar
                    vinculado à versão atual desses termos de serviço.</p>
                <h3>Lei aplicável</h3>
                <p>
                    Estes termos e condições são regidos e interpretados de acordo com as leis do matching.bet e
                    você
